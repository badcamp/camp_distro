 ...
 *
 * @PaymentMethod(
 *   deriver = "Drupal\camp_finances\Plugin\Payment\Method\OmniPayDeriver",
 *   id = "payment_omnipay",
 *   operations_provider = "\Drupal\camp_finances\Plugin\Payment\Method\OmniPayOperationsProvider",
 * )
 */
class OmniPay extends PaymentMethodBase implements ContainerFactoryPluginInterface, PaymentMethodCapturePaymentInterface, PaymentMethodRefundPaymentInterface, PaymentMethodUpdatePaymentStatusInterface {
