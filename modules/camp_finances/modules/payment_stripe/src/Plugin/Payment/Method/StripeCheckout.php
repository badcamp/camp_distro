 ...
 *
 * @PaymentMethod(
 *   deriver = "Drupal\payment_stripe\Plugin\Payment\Method\StripeCheckoutDeriver",
 *   id = "payment_stripe_checkout",
 *   operations_provider = "\Drupal\payment_stripe\Plugin\Payment\Method\StripeCheckoutOperationsProvider",
 * )
 */
class StripeCheckout extends PaymentMethodBase implements ContainerFactoryPluginInterface, PaymentMethodCapturePaymentInterface, PaymentMethodRefundPaymentInterface, PaymentMethodUpdatePaymentStatusInterface {
